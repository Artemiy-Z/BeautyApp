...
public class MassageActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MassageActivity.this, CatalogActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.pencil).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MassageActivity.this, MastersViewActivity.class);
                intent.putExtra("kategory", "massage");
        ...
        findViewById(R.id.datepicker).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!id.equals("")) {
                    ...
                    Toast.makeText(MassageActivity.this, "Сначала выберите мастера!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setNextAlpha() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MassageActivity.this, TimeSelectorActivity.class);
