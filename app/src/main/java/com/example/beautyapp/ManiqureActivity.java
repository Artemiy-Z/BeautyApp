...
public class ManiqureActivity extends AppCompatActivity {

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ManiqureActivity.this, CatalogActivity.class));
        finish();
    }
    ...
    private String cat = "maniqure";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_maniqure);
        ...
        findViewById(R.id.pencil).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManiqureActivity.this, MastersViewActivity.class);
        ...
        findViewById(R.id.datepicker).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!id.equals("")) {
                    ...
                    Toast.makeText(ManiqureActivity.this, "Сначала выберите мастера!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setNextAlpha() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManiqureActivity.this, TimeSelectorActivity.class);
