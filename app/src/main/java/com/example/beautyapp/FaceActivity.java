...
public class FaceActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(FaceActivity.this, CatalogActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] diffVariants = {
                ...
                "Маски",
                "Пиллинг",
                "Капитальный уход (все процедуры)"};
        ...
        findViewById(R.id.pencil).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FaceActivity.this, MastersViewActivity.class);
        ...
        findViewById(R.id.datepicker).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!id.equals("")) {
                    ...
                    Toast.makeText(FaceActivity.this, "Сначала выберите мастера!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setNextAlpha() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FaceActivity.this, TimeSelectorActivity.class);
