...
public class PaintActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(PaintActivity.this, CatalogActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] diffVariants = {
                "Сложность услуги...",
                "Покраска коротких волос",
                "Покраска длинных волос"};
        ...
        findViewById(R.id.pencil).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PaintActivity.this, MastersViewActivity.class);
        ...
        findViewById(R.id.datepicker).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!id.equals("")) {
                    ...
                    Toast.makeText(PaintActivity.this, "Сначала выберите мастера!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setNextAlpha() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PaintActivity.this, TimeSelectorActivity.class);
